@foreach($hoadonsach as $key=>$hoadon)
    <ul>
        <li>Hóa đơn lần {{$key+1}} <button class="btn btn-success clickhd" value="{{$hoadon->id}}">Hóa đơn</button></li>
        <li id="hoadon-{{$hoadon->id}}" class="hoadon123 hide" style="list-style: none">

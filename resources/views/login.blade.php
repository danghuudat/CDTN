...
<div class="login-form">
    <div class="head">
        <img src="images/1.jpg" width="115px" height="115px" alt=""/>
    ...
    <form>
        ...
        <div class="p-container">
            <label style="color: whitesmoke"><input type="checkbox" name="checkbox" ><i></i>Remember Me</label>
